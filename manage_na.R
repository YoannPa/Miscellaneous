...
#'               NAs:
#'               "keep" - does nothing
#'               "remove" - removes all rows containing at least 1 NA.
#'               "impute" - removes rows containing only NAs and impute missing
#'               values in remaining rows. The imputation uses the groups
